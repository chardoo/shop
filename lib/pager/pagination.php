...
class bootPagination
{
	...
	function __construct($pagenumber,$limit,$totalRecords=0,$url="#",$pagingUrl)
	{
		...
		$this->showfirst = true;
		$this->showlast = true;
		$this->paginationcss = "pagination-normal";
		$this->paginationstyle = 0;  // 1: advance, 0: normal, 2: pager
		
		$this->defaultUrl = $url; // in case of ajax pagination
		$this->paginationUrl = $pagingUrl; // # incase of ajax pagination e.g index.php?p=[p] --> 
